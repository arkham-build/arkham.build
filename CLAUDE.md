...
- Prefer adding CSS styles via scoped `<module>.module.css` modules. Only use inline styles for setting dynamic CSS variables.

### Dependency management
- When installing modules via `npm`, always use the `-E` flag to install the exact version.